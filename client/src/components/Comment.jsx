            ...
            { isEditing ? ( 
                ...
                <Textarea className="mb-2" value={editedContent} onChange={(e) => setEditedContent(e.target.value)}/>
                    <div className="flex justify-end gap-2 text-xs">
                        <Button onClick={handleSave} type='button' gradientDuoTone='purpleToBlue' size='sm'>Save</Button>
                        <Button onClick={() => setIsEditing(false)} outline type='button' gradientDuoTone='purpleToBlue' size='sm'>Cancel</Button>
                    </div>
                </>
            ): (
                <>
