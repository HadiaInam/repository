  ...
  return (
    <div className='mx-auto max-w-lg p-3 w-full'>
        ...
        <form className='flex flex-col gap-4 ' onSubmit={handleSubmit}>
            ...
            <img src={imageFileUrl || currentUser.profilePicture} alt="User" className={`rounded-full w-full object-cover h-full border-8 border-[lightgray] ${imageFileUploadProgress && imageFileUploadProgress < 100 && 'opacity-60'}`}/>
            </div>
        ...
        {updateUserError && <Alert color='failure' className='mt-5'>{error}</Alert>}
